...
export class CantidadplatosComponent implements OnInit {
  ...
  editandoCantidadPlato: boolean = false; // Variable para indicar si se está editando un plato existente
  idCantidadPlatoEditar: string = ''; // Variable para almacenar el ID del plato en caso de edición
