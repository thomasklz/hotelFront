...
@Component({
  selector: 'app-editarperfilcajero',
  templateUrl: './editarperfilcajero.component.html',
  styleUrls: ['./editarperfilcajero.component.scss']
})
export class EditarperfilcajeroComponent implements OnInit {
